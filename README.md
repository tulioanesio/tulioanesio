...
![My Skills](https://skillicons.dev/icons?i=js,html,css,react,tailwind,nodejs,express,nestjs,ts,prisma,mongodb,mysql,postgresql,java,spring,linux,docker,postman,git,github,vscode)
